...
def main():
    ...
    sampled = sample_with_masking(seed_tokens.unsqueeze(0),encodedTokens.unsqueeze(0),transformer, steps=256 - SEED_TOKEN_COUNT, temperature=5.0, top_k = 100, top_p = 0.95)
